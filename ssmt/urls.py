...
urlpatterns = [
    ...
    url(r'^sample_up/', views.sample_up_view, name='ssmt_sample_up'),
    url(r'^render_geojson/', views.render_geojson_view, name='render_geojson'),
    url(r'^download_single/', views.download_single_view, name='ssmt_download_single'),
    url(r'^delete_single/', views.delete_single_view, name='ssmt_delete_single'),
    url(r'^delete_up/', views.delete_up_view, name='ssmt_delete_up'),
