...
urlpatterns = [
    ...
    url(r'^existing_wm/', views.existing_wm_view, name = 'shbt_existing_wm'),
    url(r'^existing_wm_dl/', views.existing_wm_view_dl, name = 'shbt_existing_wm_dl'),
    url(r'^lagoon/', views.lagoon_view, name = 'shbt_lagoon'),
    url(r'^lagoon_dl/', views.lagoon_view_dl, name = 'shbt_lagoon_dl'),
    url(r'^lift_stations/', views.lift_stations_view, name = 'shbt_lift_stations'),
    url(r'^lift_stations_dl/', views.lift_stations_view_dl, name = 'shbt_lift_stations_dl'),
    ...
    url(r'^pumphouses/', views.pumphouses_view, name = 'shbt_pumphouses'),
    url(r'^pumphouses_dl/', views.pumphouses_view_dl, name = 'shbt_pumphouses_dl'),
    ...
    url(r'^res_soils/', views.res_soils_view, name = 'shbt_res_soils'),
    url(r'^res_soils_dl/', views.res_soils_view_dl, name = 'shbt_res_soils_dl'),
    url(r'^sewage_lines/', views.sewage_lines_view, name = 'shbt_sewage_lines'),
    url(r'^sewage_lines_dl/', views.sewage_lines_view_dl, name = 'shbt_sewage_lines_dl'),
    url(r'^storage_tanks/', views.storage_tanks_view, name = 'shbt_storage_tanks'),
    url(r'^storage_tanks_dl/', views.storage_tanks_view_dl, name = 'shbt_storage_tanks_dl'),
